            ...
            <div class="bg-white p-8 rounded-3xl shadow-lg border border-[#D4AF37]/20">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nombre" value="<?php echo e(old('nombre')); ?>" class="w-full bg-[#FDF2D0]/30 border-[#D4AF37]/30 rounded-xl p-3 focus:ring-[#D4AF37] focus:border-[#D4AF37]" placeholder="Ej. Collar de Perlas con Dije Dorado">
                    </div>
