...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="p-6 lg:p-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="<?php echo e(route('inventory.create')); ?>" class="bg-[#D4AF37] text-white px-6 py-3 rounded-full font-bold shadow-md hover:bg-[#B8962E] transition-all">
                + NUEVA PIEZA
            </a>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-[#FDF2D0]/10 transition-colors">
                        ...
                        <td class="p-4">
                            <div class="font-bold text-[#1A1A1A]"><?php echo e($producto->nombre); ?></div>
                        ...
                        <td class="p-4 text-center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($producto->inventario <= 5): ?>
                                <span class="bg-red-100 text-red-700 px-3 py-1 rounded-full text-xs font-bold">⚠️ <?php echo e($producto->inventario); ?></span>
                            <?php else: ?>
                                <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold"><?php echo e($producto->inventario); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="p-4 text-right text-gray-500 font-mono text-sm">$<?php echo e(number_format($producto->precompra, 2)); ?></td>
                        <td class="p-4 text-right font-bold text-[#D4AF37] font-mono">$<?php echo e(number_format($producto->preventa, 2)); ?></td>
                        <td class="p-4 text-center space-x-2">
                            ...
                            <form action="<?php echo e(route('productos.destroy', $producto->idproducto)); ?>" method="POST" class="inline" onsubmit="return confirm('¿Estás seguro de eliminar esta pieza?');">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\gestion-bisuteria\resources\views/inventory/index.blade.php ENDPATH**/ ?>