        ...
        <form action="<?php echo e(route('productos.update', $producto->idproducto)); ?>" method="POST" class="bg-white p-8 rounded-3xl shadow-lg border border-[#D4AF37]/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    name="inventario" 
                    value="<?php echo e($producto->inventario); ?>" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        step="0.01" 
                        name="preventa" 
                        value="<?php echo e($producto->preventa); ?>" 
...
<?php endif; ?><?php /**PATH C:\laragon\www\gestion-bisuteria\resources\views/inventory/edit.blade.php ENDPATH**/ ?>